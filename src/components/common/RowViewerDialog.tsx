    ...
    return (
        <Dialog open={open} onOpenChange={onOpenChange}>
            <DialogContent className="max-w-4xl max-h-[85vh] flex flex-col">
                ...
                {error && (
                    <div className="mx-6 mt-4 p-3 bg-red-50 text-red-600 border border-red-200 rounded-md text-sm font-mono whitespace-pre-wrap">
                        {error}
                    </div>
                )}
                            ...
                            {columns.map((col) => {
                                ...
                                return (
                                    <TableRow key={col.name}>
                                        ...
                                        <TableCell className="align-top">
                                            <span className="text-xs text-muted-foreground">{col.comment || '-'}</span>
                                        </TableCell>
                                        <TableCell className="align-top">
                                            {editable ? (
                                                isLongText ? (
