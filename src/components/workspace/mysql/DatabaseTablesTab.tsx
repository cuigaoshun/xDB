...
import { invokeSqliteSql, invokeSql } from "@/lib/api.ts";
        ...
        <div className="h-full flex flex-col bg-background">
            ...
            <div className="p-2 border-b flex gap-2 items-center bg-muted/30 justify-between">
                <div className="flex items-center gap-2 flex-1">
                    <div className="flex flex-col border rounded-md overflow-hidden bg-background mr-2 min-w-[85px]">
                        <Button
                            variant="ghost"
                            className={cn(
                                "h-[26px] px-3 py-0 rounded-none border-b justify-start",
                                showQuery ? "bg-accent text-accent-foreground" : "text-muted-foreground hover:bg-muted"
                            )}
                            onClick={() => {
                        ...
                        >
                            <PanelTop className="h-3.5 w-3.5 mr-2 shrink-0" />
                            <span className="text-xs font-medium truncate">{t('mysql.query', 'Query')}</span>
                        </Button>
                        <Button
                            variant="ghost"
                            className={cn(
                                "h-[26px] px-3 py-0 rounded-none justify-start",
                                showTables ? "bg-accent text-accent-foreground" : "text-muted-foreground hover:bg-muted"
                            )}
                            onClick={() => {
                        ...
                        >
                            <PanelBottom className="h-3.5 w-3.5 mr-2 shrink-0" />
                            <span className="text-xs font-medium truncate">{t('mysql.tables', 'Tables')}</span>
                        </Button>
                    </div>
