...
export function MemcachedWorkspace({ name, connectionId }: { name: string; connectionId: number }) {
  ...
  const handleDelete = async () => {
      ...
      try {
          ...
          // Optionally remove from history? Maybe not, as users might want to confirm it's gone.
      } catch (error) {
