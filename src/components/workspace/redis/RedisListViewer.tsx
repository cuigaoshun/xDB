        ...
        <div className="flex flex-col h-full">
            ...
            <div className="p-2 border-b flex justify-end items-center gap-2">
                <Button size="sm" onClick={() => setIsAddDialogOpen(true)}
                        className="gap-1 bg-blue-600 hover:bg-blue-500 text-white shadow-sm">
                                                ...
                                                <DropdownMenu>
                                                    ...
                                                    <DropdownMenuContent align="end" className="w-56">
                                                        ...
                                                        <div className="px-2 pt-2 pb-0.5 text-xs text-muted-foreground">
                                                            {t('redis.deleteListItemPrompt')}
                                                        </div>
                                                        <div
                                                            className="px-2 pb-2 text-xs font-mono font-medium break-all">
                                                            {String(val)}
                                                        </div>
                                                        <DropdownMenuSeparator/>
                                                        <DropdownMenuItem
